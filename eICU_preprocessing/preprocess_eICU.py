...
parser = argparse.ArgumentParser(description='preprocessing phase one')
...
nursingchart.to_csv(os.path.join(args.path, 'nursingchart_features.csv'), index=False)
...
lab.to_csv(os.path.join(args.path, 'lab_features.csv'), index=False)
...
patients = pd.read_csv(os.path.join(args.path, 'patient_features.csv'))
nursingchart = pd.read_csv(os.path.join(args.path, 'nursingchart_features.csv'))
lab = pd.read_csv(os.path.join(args.path, 'lab_features.csv'))
...
all_features.to_csv(os.path.join(args.path, 'eicu_features_unimputed.csv'), index=False)
...
all_features.to_csv(os.path.join(args.path, 'eicu_features.csv'), index=False)
